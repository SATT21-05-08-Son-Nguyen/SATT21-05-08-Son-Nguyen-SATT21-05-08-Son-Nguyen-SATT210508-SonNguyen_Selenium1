...
public class BookTicketPage {
    ...
    public void selectDropdown(String Date, String DepartStation, String ArriveStation, String SeatType, int TicketAmount) throws InterruptedException {
        ...
        int ticketAmount = TicketAmount - 1;
        selectTicketAmount.selectByIndex(ticketAmount);

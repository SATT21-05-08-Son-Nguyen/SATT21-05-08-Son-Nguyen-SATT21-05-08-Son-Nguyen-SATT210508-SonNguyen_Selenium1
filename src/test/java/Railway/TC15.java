...
public class TC15 extends TestBase{
    ...
    public void TC15(String departStation,String arriveStation,int seatTypeHS,int seatTypeSS,int seatTypeSSC,int seatTypeHB,int seatTypeSB,int seatTypeSBC) {
        System.out.println(String.format("%s - %s - %s - %s - %s - %s - %s - %s", departStation, arriveStation, seatTypeHS, seatTypeSS, seatTypeSSC, seatTypeHB, seatTypeSB, seatTypeSBC));
        ...
        timetablePage.scrollTimetablePage(departStation,arriveStation);
    ...
    public Object[][] dataProvider() {
        ...
        Object[][] object = new Object[][]{
                {departStation,arriveStation,seatTypeHS,seatTypeSS,seatTypeSSC,seatTypeHB,seatTypeSB,seatTypeSBC}
        };
